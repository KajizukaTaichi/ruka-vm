...
|||
|---|---|
|プログラム領域|実行されるバイトコードが格納されます。不変です。|
|メモリ領域|データやオブジェクトが格納されます。プログラム側から変更できます。|
|スタック領域|関数などとデータ受け渡しする際に使います|
|関数スタック|呼び出し元アドレスが格納されます|
|レジスタユニット|プログラムの実行に必要なレジスタが格納されます|
